            ...
            <div class="card-body">
                <form action="{{ route('admin.product.update', $product->id) }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <textarea name="short_description" class="form-control" id="form-control">{!! $product->short_description !!}</textarea>
                    </div>

                    <div class="form-group">
                        <label>Long Description</label>
                        <textarea name="long_description" class="form-control summernote" id="form-control">{!! $product->long_description !!}</textarea>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <textarea name="seo_description" class="form-control" id="form-control">{!! $product->seo_description !!}</textarea>
                    </div>
