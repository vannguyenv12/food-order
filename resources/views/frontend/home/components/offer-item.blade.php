                    ...
                    <div class="fp__offer_item_single">
                        ...
                        <div class="text">
                            ...
                            @if ($dailyOffer->product->offer_price > 0)
                                <span>{{ discountInPercent($dailyOffer->product->price, $dailyOffer->product->offer_price) }}%
                                    off</span>
                            @else
                                {{ currencyPosition($dailyOffer->product->price) }}
                            @endif
                            <a class="title"
                            ...
                            <ul class="d-flex flex-wrap">
                                ...
                                <li><a href="{{ route('product.show', $dailyOffer->product->slug) }}"><i
